                                    ...
                                    <div class="col-6 col-xl-6">
                                        <div class="media text-center text-xl-left">
                                            <div class="avatar avatar-sm d-none d-xl-inline-block mr-5">
                                                <img src="../../../photo/adm/<?php echo $adm_photo;?>" class="avatar-img" alt="">
                                            </div>

                                            <div class="media-body align-self-center text-truncate">
                                                <h6 class="text-truncate mb-n1"><?php echo $admin_fname_root." ".$admin_lname_root;?></h6>
...
?>
                                ...
                                <div class="message">
                                    ...
                                    <a class="avatar avatar-sm mr-4 mr-lg-5" data-chat-sidebar-toggle="#chat-1-user-profile">
                                        <img class="avatar-img" src="../../../photo/adm/<?php echo $adm_photo;?>" alt="">
                                    </a>
                                        ...
                                        <div class="message-row">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="message-content bg-light">
                                                    <h6 class="mb-2"><?php echo $admin_fname." ".$admin_lname;?></h6>
...
<?php
    ...
    if(isset($_POST["msg_send_textbox"]))
    {
        ...
        $qry = "Insert into chat_stu_admin (msg_sender,admin_id,stu_id,msg_type,chat_msg,seen,date,time) values ('s','$admin_id','$stu_id','m','$msg_f','0','$t_date','$t_time')";
        // echo $qry;
        $fire=$conn->query($qry);
