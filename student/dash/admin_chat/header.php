...
<?php
                        ...
                        $str_chat = "<a class='nav-link position-relative p-0 py-xl-3' href='../home.php?roomid=".$room_id."&roomcode=".$room_code."' title='Report Issue' role='tab'>";
                        echo $str_chat;
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="avatar avatar-online mr-5">
                                                            <img class="avatar-img" src="../../../photo/adm/<?php echo $adm_photo;?>" alt="Anna Bridges">
                                                        </div>
                                            ...
                                            <div class="card card-active-listener">
                                                <div class="card-body">
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="avatar avatar-online mr-5">
                                                            <img class="avatar-img" src="../../../photo/lb_a/<?php echo $admin_photo;?>" alt="Anna Bridges">
                                                        </div>
