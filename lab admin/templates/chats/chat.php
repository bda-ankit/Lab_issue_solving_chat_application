...
$qes_adm_name="Select * from admin_details where admin_id = '$admin_id' ;";
$qry_adm_name=$conn->query($qes_adm_name);
$res_adm_name=$qry_adm_name->fetch_assoc();

$adm_fname = $res_adm_name["admin_fname"];
$adm_lname = $res_adm_name["admin_lname"];
$adm_enrol = $res_adm_name["admin_enrol"];
$adm_photo = $res_adm_name["admin_photo"];
