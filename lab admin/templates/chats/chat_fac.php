<?php
	include("header_fac.php");
    $fac_id = $_GET["facid"];


$qes_fac_name="Select * from faculty_details where fac_id = '$fac_id' ;";
$qry_fac_name=$conn->query($qes_fac_name);
$res_fac_name=$qry_fac_name->fetch_assoc();

$fac_fname = $res_fac_name["fac_fname"];
$fac_lname = $res_fac_name["fac_lname"];
$fac_enrol = $res_fac_name["fac_enrol"];
$fac_photo = $res_fac_name["fac_photo"];
...
<script type="text/javascript">
        ...
        var url_array = full_url.split('?facid=') // Split the string into an array with / as separator
...
// this is for reloading table
        function update(){
            $('#chat_reload').load("chat_fac.php?facid="+last_segment+" #chat_reload");
        }
                                    ...
                                    <div class="col-6 col-xl-6">
                                        <div class="media text-center text-xl-left">
                                            <div class="avatar avatar-sm d-none d-xl-inline-block mr-5">
                                                <img src="../../../photo/fac/<?php echo $fac_photo;?>" class="avatar-img" alt="">
                                            </div>

                                            <div class="media-body align-self-center text-truncate">
                                                <h6 class="text-truncate mb-n1"><?php echo $fac_fname." ".$fac_lname;?></h6>
                                                <small class="text-muted">Enrollment</small>
                                                <small class="text-muted mx-2"> • </small>
                                                <small class="text-muted"><?php echo $fac_enrol;?></small>
                                            </div>
                                        </div>
                                    </div>
...
$qes123="Select * from chat_fac_admin where fac_id = '$fac_id' and admin_id = '$admin_id' ";
//echo $qes123;
...
?>
                                ...
                                <div class="message">
                                    ...
                                    <a class="avatar avatar-sm mr-4 mr-lg-5" data-chat-sidebar-toggle="#chat-1-user-profile">
                                        <img class="avatar-img" src="../../../photo/fac/<?php echo $fac_photo;?>" alt="">
                                    </a>
                                        ...
                                        <div class="message-row">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="message-content bg-light">
                                                    <h6 class="mb-2"><?php echo $fac_fname." ".$fac_lname;?></h6>
...
?> 
                                ...
                                <div class="message message-right">
                                    ...
                                    <div class="avatar avatar-sm ml-4 ml-lg-5 d-none d-lg-block">
                                        <img class="avatar-img" src="../../../photo/lb_a/<?php echo $admin_photo;?>" alt="">
                                    </div>
...
<?php
    ...
    if(isset($_POST["msg_send_textbox"]))
    {
        ...
        $qry = "Insert into chat_fac_admin (msg_sender,admin_id,fac_id,msg_type,chat_msg,seen,date,time) values ('a','$admin_id','$fac_id','m','$msg_f','0','$t_date','$t_time')";
        // echo $qry;
        $fire=$conn->query($qry);
