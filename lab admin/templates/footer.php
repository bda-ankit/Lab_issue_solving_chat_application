                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="chat">
                                    <div class="chat-list">
                                        ...
                                        <a href="chat.php" class="right-sidebar-toggle chat-item unread" data-sidebar-id="chat-right-sidebar">
                                        ...
                                        <a href="chat.php" class="right-sidebar-toggle chat-item unread active-user" data-sidebar-id="chat-right-sidebar">
                                            <div class="user-avatar">
...
<!-- Mirrored from phantom-themes.com/flatify/theme/templates/admin1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 09:35:14 GMT -->
</html>