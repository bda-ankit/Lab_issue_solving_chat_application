...
// this is for reloading table
        // function update(){
        //     $('#join_stu').load("header.php?facid="+last_segment+" #join_stu");
        // }
...
{
$fac_id1 = $res_sub["fac_id"];

;


    $qes10="Select * from faculty_details where fac_id = '$fac_id1';";
    // echo $qes10;
    ...
    $str="<a class='text-reset nav-link p-0 mb-6' href='chat_fac.php?facid=".$fac_id1."&room_id=".$room_id."'>";
    echo $str;
