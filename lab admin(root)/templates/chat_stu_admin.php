...
?>
 ...
 <div class="panel panel-darkblue">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Chat Student Admin Table</h4>
                                </div>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                            	...
                                            	<?php
                                            	$adm="Select * from chat_stu_admin;";
												$qry=$conn->query($adm);
                                        ...
                                        <tbody>
                                            <tr>
												...
												<td>
<?php
$str_go = "<a  style='margin-top: -4px;' onclick='return Confirm_Delete()' href='delete_chat_stu_admin.php?chat_a_id=".$res['chat_a_id']."' class='btn btn-danger btn-rounded m-b-xxs'><i class='far fa-trash-alt'></i></a>";
echo $str_go;
}
?>
                                                </td>
