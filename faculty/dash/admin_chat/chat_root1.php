...
// this is for reloading table
        function update(){
            $('#chat_reload').load("chat_root1.php?roomid="+last_segment+" #chat_reload");
        }
...
$adm_id_new = $_GET["admin_id"];


$qes_admin_data_new_up = "select * from admin_details where root_admin='1';";

$qry_admin_data_new_up=$conn->query($qes_admin_data_new_up);
$res_admin_data_new_up=$qry_admin_data_new_up->fetch_assoc();

$admin_fname_new = $res_admin_data_new_up["admin_fname"];
$admin_lname_new = $res_admin_data_new_up["admin_lname"];
$admin_photo_new = $res_admin_data_new_up["admin_photo"];
$admin_mail_new = $res_admin_data_new_up["admin_mail"];
$admin_enrol_new = $res_admin_data_new_up["admin_enrol"];
$admin_number_new = $res_admin_data_new_up["admin_number"];
                                    ...
                                    <div class="col-6 col-xl-6">
                                        <div class="media text-center text-xl-left">
                                            <div class="avatar avatar-sm d-none d-xl-inline-block mr-5">
                                                <img src="../../../photo/adm/<?php echo $admin_photo_new;?>" class="avatar-img" alt="">
                                            </div>

                                            <div class="media-body align-self-center text-truncate">
                                                <h6 class="text-truncate mb-n1"><?php echo $admin_fname_new." ".$admin_lname_new;?></h6>
                                                <small class="text-muted">Enrollment</small>
                                                <small class="text-muted mx-2"> • </small>
                                                <small class="text-muted"><?php echo $admin_enrol_new;?></small>
                                            </div>
                                        </div>
                                    </div>
...
<?php
    ...
    if(isset($_POST["msg_send_textbox"]))
    {
        ...
        $qry = "Insert into chat_fac_admin (msg_sender,admin_id,fac_id,msg_type,chat_msg,seen,date,time) values ('f','$admin_id','$fac_id','m','$msg_f','0','$t_date','$t_time')";
        // echo $qry;
        $fire=$conn->query($qry);
