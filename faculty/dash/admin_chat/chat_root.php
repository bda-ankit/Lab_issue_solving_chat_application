...
// this is for reloading table
        function update(){
            $('#chat_reload').load("chat_root.php?roomid="+last_segment+" #chat_reload");
        }
...
$qes_root_admin_data="Select * from admin_details where admin_id = '$admin_id1' ";
// echo $qes_root_admin_data;
$qry_root_admin_data=$conn->query($qes_root_admin_data);
$res_root_admin_data=$qry_root_admin_data->fetch_assoc();

$admin_fname_root1 = $res_root_admin_data["admin_fname"];
$admin_lname_root1 = $res_root_admin_data["admin_lname"];
$admin_photo_root1 = $res_root_admin_data["admin_photo"];

// echo $admin_fname_root1." ".$admin_lname_root1;
                                    ...
                                    <div class="col-6 col-xl-6">
                                        <div class="media text-center text-xl-left">
                                            <div class="avatar avatar-sm d-none d-xl-inline-block mr-5">
                                                <img src="../../../photo/adm/<?php echo $admin_photo;?>" class="avatar-img" alt="">
                                            </div>

                                            <div class="media-body align-self-center text-truncate">
                                                <h6 class="text-truncate mb-n1"><?php echo $admin_fname_root1." ".$admin_lname_root1;?></h6>
                                                <small class="text-muted">Enrollment</small>
                                                <small class="text-muted mx-2"> • </small>
                                                <small class="text-muted"><?php echo $admin_enrol_root;?></small>
                                            </div>
                                        </div>
                                    </div>
...
$qes123="Select * from chat_fac_admin where fac_id = '$fac_id' and admin_id = '$admin_id1' ";
// echo $qes123;
...
?>
                                ...
                                <div class="message">
                                    ...
                                    <a class="avatar avatar-sm mr-4 mr-lg-5" data-chat-sidebar-toggle="#chat-1-user-profile">
                                        <img class="avatar-img" src="../../../photo/adm/<?php echo $admin_photo_root1;?>" alt="">
                                    </a>
                                        ...
                                        <div class="message-row">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="message-content bg-light">
                                                    <h6 class="mb-2"><?php echo $admin_fname_root1." ".$admin_lname_root1;?></h6>
...
<?php
    ...
    if(isset($_POST["msg_send_textbox"]))
    {
        ...
        $qry = "Insert into chat_fac_admin (msg_sender,admin_id,fac_id,msg_type,chat_msg,seen,date,time) values ('f','$admin_id1','$fac_id','m','$msg_f','0','$t_date','$t_time')";
        // echo $qry;
        $fire=$conn->query($qry);
